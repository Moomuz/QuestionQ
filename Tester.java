...
public class Tester {
	...
	public static void main(String[] args)
	{
		...
		String rosterInput = args[0];
		Roster roster1 = new Roster(rosterInput);
		roster1.getRoster();
		...
		ArrayList<Student> students = roster1.getRoster();
		...
		ecField.addActionListener(event -> 
		{
			...
			Student s = roster1.findStudent(q.getStudentID());
	    	...
	    	if(qNumberIsValid == true && ECIsValid == true)
	    	{
				...
				s.addExtraCredit(EC);
				//update Roster.txt
				roster1.inputExtraCredit(q.getStudentID(), s.getExtraCredit());
